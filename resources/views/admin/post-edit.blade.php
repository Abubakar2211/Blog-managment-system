                                            ...
                                            <div class="d-flex">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="status"
                                                        value="draft" id="draft" {{$post->status == 'draft' ? 'checked' : ''}} />
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="status"
                                                        value="published" id="published" {{$post->status == 'published' ? 'checked' : ''}}  />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" id="categories" name="category_id[]" multiple>
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}" {{in_array($category->id,$selectCategories) ? 'selected' : ''}}>
                                                        {{ $category->name }}
                                                    </option>
                                                @endforeach
                                            </select>
